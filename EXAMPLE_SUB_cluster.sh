...
# One should add a seqfold, PeptideBuilder and nupack pip installation as wheels, or simply "pip install <package>" depending on the cluster permissions.
...
date -u
# seq1:
python main.py --run_num=0 --mode='' --aptamerSeq='' --ligand='' --ligandType='' --ligandSeq='' --k=5000
